...
import com.sigdev.sasgame.utils.RandomUtils;

/**
 * Created by benedetto.sigillo on 19/04/2017.
 */

public class GroundLeft extends GameActor {
    ...
    public GroundLeft(Body body) {
        ...
        textureRegionBounds = new Rectangle(transformToScreenX(body.getPosition().x-0.4f), transformToScreenY(body.getPosition().y),
    ...
    @Override
    public GroundLeftUserData getUserData() {
        return (GroundLeftUserData) userData;
    }
